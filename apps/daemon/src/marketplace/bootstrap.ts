...
export async function bootstrapMarketplace(): Promise<void> {
  ...
  try {
    ...
    await runClaudeCommand(claudePath, claudePrependArgs, ['plugin', 'uninstall', pluginId]);
  ...
  try {
    ...
    await runClaudeCommand(claudePath, claudePrependArgs, ['plugin', 'marketplace', 'remove', MARKETPLACE_NAME]);
  ...
  try {
    ...
    await runClaudeCommand(claudePath, claudePrependArgs, ['plugin', 'marketplace', 'add', MARKETPLACE_DIR]);
  ...
  try {
    ...
    await runClaudeCommand(claudePath, claudePrependArgs, ['plugin', 'install', pluginId]);
